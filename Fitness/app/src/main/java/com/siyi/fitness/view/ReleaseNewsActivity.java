...
public class ReleaseNewsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String TITLE_NAME = "News";
    ...
    protected void initView() {
        ...
        uiFlusHandler = new MyDialogHandler(mContext, "logging in...");
    }
    ...
    private void getPhoto() {
        FishBun.with(ReleaseNewsActivity.this)
                ...
                .setActionBarTitle("Photo library")
                .textOnImagesSelectionLimitReached("The selected number is limited")
                .textOnNothingSelected("You have not selected a picture")
                .startAlbum();
    }
