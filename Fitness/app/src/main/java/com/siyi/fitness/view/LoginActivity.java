 ...
 */
private void echo() {
    Map<String, String> map = SharedPreferencesUtils.getUserInfo(mContext);//get username and password
    if (map != null) {
                ...
                case 1:
                    ...
                    if (user.getUserId() == 0) {
                        ...
                        if (result) {
                            ...
                            Toast.makeText(mContext, "User storage failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                    openActivity(MainActivity.class);
                    finish();
