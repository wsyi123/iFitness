...
import com.siyi.fitness.fragment.MeFragment;
import com.siyi.fitness.fragment.TrainingFragment;
import com.siyi.fitness.utils.AppManager;
import com.siyi.fitness.view.base.BaseActivity;
import com.siyi.fitness.view.test.VideoPlayer;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if ((System.currentTimeMillis() - mExitTime) > 800) {
                DisplayToast("Press again to exit iFitness");
